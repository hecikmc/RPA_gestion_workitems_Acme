...
public class Performer implements AdHocTask{
	...
	private final SecureEntryDTO credentials_db;
	...
	@Inject
	public Performer (Injector injector) {
    ...
    public TaskRunnerOutput run(TaskInput taskInput) {
    	rpaRunner.execute(driver -> {
    		...
    		webRobot.login();
    		workItemList = managerDDBB.extractWorkItems();
    		acmeService.updateWorkItem(workItemList, webRobot);
    		managerDDBB.updateWorkItem(workItemList);
